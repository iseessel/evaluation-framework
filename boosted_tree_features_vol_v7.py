...
DATASET = 'silicon-badge-274423.features.price_features_vol_v7'
...
args = {
    ...
    'evaluation_table_id': f'silicon-badge-274423.stock_model_evaluation.boosted_tree_price_features_vol_v7_light_prod',
    'pooled': True,
    'glue': glue,
    'options': {
        'returns_from_t': True
